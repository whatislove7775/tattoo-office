...
(function (global) {
  ...
  var DICT = {
    ...
    ru: {
      ...
      'auth.toReg': 'нет аккаунта — регистрация',
      'auth.toLogin': 'уже есть аккаунт — вход',
      'auth.badPair': 'Неверный логин или пароль.',
      'auth.exists': 'Такой логин уже занят.',
      'auth.short': 'Логин от 3 символов, пароль от 4.',
    ...
    en: {
      ...
      'auth.badPair': 'Wrong login or password.',
      'auth.exists': 'This login is already taken.',
      'auth.short': 'Login from 3 characters, password from 4.',
